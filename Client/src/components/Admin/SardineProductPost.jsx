...
import { Loader2, Trash2, PlusCircle, Edit2, X, AlertCircle, CheckCircle2 } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      ...
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-2xl md:text-3xl font-black text-gray-800">Gestion des produits de sardine</h1>
      ...
      {showForm && (
        <div className="bg-white p-6 rounded-2xl shadow-lg mb-10">
          <div className="space-y-4">
            ...
            <textarea name="content_fr" value={formData.content_fr} onChange={handleChange} placeholder="Description (FR)" rows="3" className="w-full border p-3 rounded-lg" />
            <textarea name="content_en" value={formData.content_en} onChange={handleChange} placeholder="Description (EN)" rows="3" className="w-full border p-3 rounded-lg" />
