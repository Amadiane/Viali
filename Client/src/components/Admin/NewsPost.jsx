...
//       setNewsList(data);
//     } catch (err) {
//       console.log("Erreur fetch news:", err);
//     }
//   };
...
//   // -----------------------------------------
//   // 🔥 3. Envoyer formulaire (Create/Update)
//   // -----------------------------------------
...
//       const url = form.id
//         ? `${CONFIG.BASE_URL}/api/news/${form.id}/`
...
//     await fetch(`${CONFIG.BASE_URL}/api/news/${id}/`, { method: "DELETE" });
//     fetchNews();
//   };

//   // -----------------------------------------
//   // 🔥 5. Remplir form pour Update
//   // -----------------------------------------
//   const editNews = (item) => {
//     setForm({
//       id: item.id,
...
//       <h2 className="text-2xl font-bold mb-4">Gestion des News</h2>
...
//           disabled={loading}
//         >
//           {loading ? "Envoi..." : form.id ? "Modifier" : "Créer"}
//         </button>
...
//             type="button"
//             onClick={resetForm}
//             className="ml-2 bg-gray-400 px-4 py-2 rounded text-white"
//           >
//             Annuler
//           </button>
//         )}
...
//       {/* ------------------ LISTE DES NEWS ------------------ */}
//       <div className="mt-10">
//         <h3 className="text-xl font-bold mb-3">Liste des News</h3>

//         {newsList.map((item) => (
//           <div key={item.id} className="border p-3 rounded mb-3">
//             <h4 className="text-lg font-semibold">{item.title_fr}</h4>

//             {item.image_url && (
//               <img src={item.image_url} className="w-32 mt-2 rounded" />
//             )}
