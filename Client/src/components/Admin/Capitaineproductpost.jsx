...
const CapitaineProductPost = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const url = editingId
        ? CONFIG.API_CAPITAINE_PRODUCT_UPDATE(editingId)
        : CONFIG.API_CAPITAINE_PRODUCT_CREATE;
  ...
  const handleDelete = async (id) => {
    ...
    try {
      const res = await fetch(CONFIG.API_CAPITAINE_PRODUCT_DELETE(id), {
        method: "DELETE",
      });
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                ...
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    placeholder="Ex: Smoked Captain Fish"
