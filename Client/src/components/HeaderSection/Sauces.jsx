...
import { ArrowRight, Droplets, ShoppingCart, Phone, Star, CheckCircle, TrendingUp, Users, Sparkles } from "lucide-react";
...
const Sauces = () => {
  ...
  const handleWhatsAppOrder = () => {
    window.open("https://wa.me/224613509180?text=Bonjour%20VIALI%2C%20je%20souhaite%20commander%20votre%20mayonnaise", "_blank");
  };
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-white pb-16">
            ...
            <div className="text-center mb-12">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-slide-up"
                ...
                <button
                  ...
                  <span>{t("sauces.cta_order_now")}</span>
        ...
        <div id="products" className="max-w-[1400px] mx-auto px-6 lg:px-12 py-12 md:py-16">
          ...
          <div className="max-w-2xl mx-auto">
            {products.map((product, idx) => (
              ...
              >
                <div className="bg-white rounded-3xl overflow-hidden transition-all duration-500 border-2 border-gray-100 hover:border-orange-200 shadow-2xl hover:shadow-orange-500/40 hover:-translate-y-2 flex flex-col">
                  
                  {/* Hero Image Area - LARGE */}
                  <div className="relative h-96 overflow-hidden bg-gradient-to-br from-orange-50 to-yellow-50">
                    
                    {/* Badge + Rating - SUR LA CARD UNIQUEMENT */}
                    <div className="absolute top-4 left-4 right-4 flex items-center justify-between z-20">
                      <div className="bg-gradient-to-r from-[#FFC107] to-[#FF8C00] text-white px-4 py-2 rounded-full text-sm font-bold shadow-xl"
                           style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
                        {product.badge}
                      </div>
                      <div className="bg-white/95 backdrop-blur-sm px-4 py-2 rounded-full flex items-center gap-1.5 shadow-xl">
                        <Star className="w-5 h-5 text-yellow-500 fill-current" strokeWidth={2.5} />
                    ...
                    <div className="absolute inset-0 flex items-center justify-center z-10">
                      <div className={`text-9xl md:text-[12rem] transform transition-all duration-500 sauce-icon ${
                  ...
                  <div className="p-8 md:p-10 flex flex-col">
                    ...
                    <div className="flex items-center gap-2 mb-4">
                      ...
                      <span className="text-base font-bold text-green-600" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
                        {product.orders} {t("sauces.orders_count")}
                      </span>
                    </div>

                    {/* Title - LARGE */}
                    <h3 className={`text-3xl md:text-4xl font-black text-gray-900 mb-4 leading-tight transition-colors duration-300 ${
                    ...
                    <div className="space-y-4">
                      <button
                        ...
                        className="w-full px-8 py-4 bg-gradient-to-r from-[#FFC107] to-[#FF8C00] text-white font-bold text-lg rounded-xl hover:scale-105 hover:shadow-xl hover:shadow-orange-500/40 transition-all duration-300 flex items-center justify-center gap-2"
                        style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
                        <span>{t("sauces.view_details")}</span>
                      ...
                      <button
                        ...
                        className="w-full px-8 py-4 bg-green-500 text-white font-bold text-lg rounded-xl hover:bg-green-600 transition-all duration-300 flex items-center justify-center gap-2"
                        style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
                        <ShoppingCart className="w-6 h-6" strokeWidth={2.5} />
                        <span>{t("sauces.quick_order")}</span>
                      </button>
                    </div>
                  </div>
                </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="text-center">
                ...
                <h3 className="text-xl font-black text-gray-900 mb-2" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
                  {t("sauces.trust_1_title")}
                </h3>
                <p className="text-gray-600" style={{ fontFamily: "'Inter', sans-serif" }}>
                  {t("sauces.trust_1_desc")}
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <h3 className="text-xl font-black text-gray-900 mb-2" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
                  {t("sauces.trust_2_title")}
                </h3>
                <p className="text-gray-600" style={{ fontFamily: "'Inter', sans-serif" }}>
                  {t("sauces.trust_2_desc")}
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <h3 className="text-xl font-black text-gray-900 mb-2" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
                  {t("sauces.trust_3_title")}
                </h3>
                <p className="text-gray-600" style={{ fontFamily: "'Inter', sans-serif" }}>
                  {t("sauces.trust_3_desc")}
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="relative overflow-hidden bg-gradient-to-br from-[#FFC107] to-[#FF8C00] rounded-3xl p-12 md:p-16 text-center shadow-2xl">
            ...
            <div className="relative z-10">
              <h2 className="text-3xl md:text-5xl font-black text-white mb-4"
                  style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
                {t("sauces.final_cta_title")}
              </h2>
              <p className="text-lg md:text-xl text-white/90 mb-8 max-w-2xl mx-auto"
                 style={{ fontFamily: "'Inter', sans-serif" }}>
                {t("sauces.final_cta_subtitle")}
              </p>
        ...
        <a
          href="https://wa.me/224613509180?text=Bonjour%20VIALI%2C%20je%20souhaite%20commander%20votre%20mayonnaise"
          target="_blank"
