  ...
  return (
    <>
              ...
              <div className="absolute inset-x-0 bottom-0 pb-6 sm:pb-8 md:pb-12 px-4 sm:px-6 md:px-12 lg:px-20">
                <div className="max-w-[1400px] mx-auto">
                  <div className="max-w-2xl">
                    ...
                    <div className="flex flex-row items-center gap-1.5 sm:gap-3 animate-slide-up"
                         style={{ animationDelay: '0.3s' }}>
                      <button onClick={() => navigate('/rillettes')}
                        className="group px-2.5 sm:px-6 py-1.5 sm:py-3 bg-gradient-to-r from-[#FFC107] to-[#FF8C00] text-white font-bold text-[11px] sm:text-base rounded-md sm:rounded-xl hover:scale-105 hover:shadow-2xl hover:shadow-orange-500/50 transition-all flex items-center gap-1 sm:gap-2 flex-shrink-0"
                        style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
                        <Package className="w-3 h-3 sm:w-5 sm:h-5" strokeWidth={2.5} />
                        <span className="whitespace-nowrap">{t("home.view_products")}</span>
                        <ArrowRight className="hidden sm:inline w-5 h-5 transform group-hover:translate-x-2 transition-transform" strokeWidth={2.5} />
                      </button>
                      
                      <button onClick={() => navigate('/contacternous')}
                        className="px-2.5 sm:px-6 py-1.5 sm:py-3 bg-white/10 backdrop-blur-md border-2 border-white/30 text-white font-bold text-[11px] sm:text-base rounded-md sm:rounded-xl hover:bg-white/20 transition-all flex items-center gap-1 sm:gap-2 flex-shrink-0"
                        style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
                        <Mail className="w-3 h-3 sm:w-5 sm:h-5" strokeWidth={2.5} />
      ...
      <div className="bg-white">
        ...
        {data.news.length > 0 && (
          <section className="py-6 sm:py-16 md:py-20 px-3.5 sm:px-6">
            <div className="max-w-[1400px] mx-auto">
              <div className="flex items-center justify-between mb-4 sm:mb-10 md:mb-12">
                <div className="flex items-center gap-2 sm:gap-4">
                  <div className="w-7 h-7 sm:w-12 sm:h-12 md:w-14 md:h-14 bg-gradient-to-br from-[#FFC107] to-[#FF8C00] rounded-md sm:rounded-xl flex items-center justify-center shadow-lg">
                    <Newspaper className="w-3.5 h-3.5 sm:w-6 sm:h-6 md:w-7 md:h-7 text-white" strokeWidth={2.5} />
                  </div>
                  <div>
                    <h2 className="text-base sm:text-2xl md:text-4xl font-black text-gray-900" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
                      {t("home.latest_news")}
                    </h2>
                    <div className="w-10 sm:w-16 md:w-20 h-0.5 sm:h-1 bg-gradient-to-r from-[#FFC107] to-[#FF8C00] rounded-full mt-1 sm:mt-2"></div>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 gap-2.5 sm:gap-6">
                {data.news.map((item) => (
                  <article key={item.id} className="group cursor-pointer" onClick={() => navigate('/actualites')}>
                    <div className="bg-white rounded-lg sm:rounded-3xl overflow-hidden border sm:border-2 border-gray-100 hover:border-orange-200 shadow-sm sm:shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all duration-500">
                      {item.image_url && (
                      ...
                      <div className="p-2 sm:p-5">
                        <div className="flex items-center gap-1 sm:gap-2 text-[10px] sm:text-xs text-gray-500 mb-1 sm:mb-3">
                          <Calendar className="w-2.5 h-2.5 sm:w-3 sm:h-3 text-[#FF8C00]" strokeWidth={2.5} />
                          <time>{new Date(item.created_at).toLocaleDateString(i18n.language)}</time>
                        </div>
                        <h3 className="text-xs sm:text-lg font-black text-gray-900 mb-0 sm:mb-2 line-clamp-2 group-hover:text-[#FF8C00] transition-colors"
                            style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
        ...
        {/* CTA Final */}
        <section className="relative py-8 sm:py-20 md:py-24 px-3.5 sm:px-4 overflow-hidden bg-gradient-to-br from-orange-50 via-yellow-50/30 to-orange-50">
          ...
          <div className="relative max-w-4xl mx-auto text-center">
            <div className="inline-flex items-center justify-center w-11 h-11 sm:w-20 sm:h-20 bg-gradient-to-br from-[#FFC107] to-[#FF8C00] rounded-lg sm:rounded-2xl mb-3 sm:mb-8 shadow-xl">
              <Phone className="w-5 h-5 sm:w-10 sm:h-10 text-white" strokeWidth={2.5} />
            </div>
            <h2 className="text-lg sm:text-4xl md:text-5xl lg:text-6xl font-black mb-2 sm:mb-6 gradient-text"
                style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
              {t("home.cta_final_title")}
            </h2>
            <p className="text-xs sm:text-lg md:text-xl text-gray-600 mb-4 sm:mb-10 max-w-2xl mx-auto"
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-2 sm:gap-4">
              <a href="/contacternous"
                 className="group inline-flex items-center gap-1.5 sm:gap-3 px-4 sm:px-8 py-2 sm:py-4 bg-gradient-to-r from-[#FFC107] to-[#FF8C00] text-white font-bold text-xs sm:text-lg rounded-lg sm:rounded-xl shadow-2xl hover:scale-105 transition-all w-full sm:w-auto justify-center"
                 style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
                <Mail className="w-3.5 h-3.5 sm:w-5 sm:h-5" strokeWidth={2.5} />
                <span>{t("home.contact_us")}</span>
                <ArrowRight className="w-3.5 h-3.5 sm:w-5 sm:h-5 transition-transform group-hover:translate-x-2" strokeWidth={2.5} />
              </a>
              <a href="tel:+224610207407"
                 className="inline-flex items-center gap-1.5 sm:gap-3 px-4 sm:px-8 py-2 sm:py-4 bg-white border-2 border-orange-200 text-[#FF8C00] font-bold text-xs sm:text-lg rounded-lg sm:rounded-xl hover:border-[#FF8C00] hover:shadow-lg transition-all w-full sm:w-auto justify-center"
                 style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
                <Phone className="w-3.5 h-3.5 sm:w-5 sm:h-5" strokeWidth={2.5} />
        ...
        >
          ...
          {/* Main button — réduit sur mobile uniquement, taille normale dès sm: */}
          <div className="relative w-11 h-11 sm:w-14 sm:h-14 md:w-16 md:h-16 bg-gradient-to-br from-green-500 to-green-600 
            ...
            <svg className="w-6 h-6 sm:w-8 sm:h-8 md:w-9 md:h-9 text-white" fill="currentColor" viewBox="0 0 24 24">
